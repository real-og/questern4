...
ask_for_victim = """❗️Чтобы получить загадку, вам нужно принести в жертву 1 игрока. 
Выберите добровольца и передайте его моему помощнику.
"""


send_photo = 'Отправляйте фото'

victim_received = "❗️ Чтобы узнать загадку, посмотрите видео и напишите кодовое слово."
...
❗️Вам потребуется особый свет, чтобы разгадать эту загадку."""
