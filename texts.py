...
ask_for_victim = """Чтобы получить загадку, вам нужно принести в жертву 1 игрока.

❓Кто готов принести себя в жертву в обмен на загадку? 

❗️ Передайте жертву моему помощнику. 
"""


send_photo = 'Отправляйте фото'

victim_received = "❗️Напишите кодовое слово, чтобы узнать загадку."
...
task2_3 = "❗️Вам потребуется особый свет, чтобы разгадать эту загадку."
...
task7_3 = """❗️Это испытание для самого главного человека среди вас. Вы знаете, кто это? 
...
task6_new1 = """❗️Эта загадка разбита на части и закодирована. 
