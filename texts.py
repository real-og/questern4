...
ask_for_victim = """Чтобы получить загадку, вам нужно принести в жертву одного игрока.

❓Кто готов принести себя в жертву в обмен на загадку? 

❗️ Передайте жертву моему помощнику и нажмите на кнопку ⤵️"""


send_photo = 'Отправляйте фото'

victim_received = "❗️Напишите кодовое слово, которое вам сообщит мой помощник."

photo_received = """Я принимаю вашу жертву. 
Введите кодовое слово, которое вам сообщит мой помощник"""

enter_code_w = 'Теперь вводите кодовое слово, которое сообщит мой помощник'
...
task1_3_1 = """Помощник даст вам загадку. Расшифруйте вопросы. Ответ на вопрос - это цифра номера телефона ☎️"""
task1_3_2="""Номер состоит из одиннадцати цифр и начинается на 8.
Напишите номер телефона в формате 89…"""
...
task4_3 = """Я приготовил для вас подарок. 🎁 

♦️В коробке спрятана загадка из 6 слов. 
♦️ Все слова зашифрованы. 
♦️ Расшифруйте каждое слово, отгадайте загадку и напишите ответ."""
...
task5_3_1 = """Я хочу, чтобы вы запомнили эту игру. Следуйте правилам:

1️⃣ Сделайте фотографии по инструкции, которую вы получите. 

2️⃣ Покажите фотографии моему помощнику. Он их проверит. 

3️⃣ Загрузите фотографии в Облако. Я должен их увидеть.
"""
task5_3_2 = 'Загрузите ваши фотографии по <a href="https://cloud.mail.ru/public/Jdq8/W3QzKVXEU">ссылке</a>'
