...
succes_registrated = """Вы в игре! 🔥
Чтобы получить первую загадку, нажмите на кнопку «Начать игру». Она находится внизу экрана ⤵️"""
...
task_1_finish = "В настоящее время абонент недоступен. Но испытание считается пройдённым. Поздравляю! 🎉"
